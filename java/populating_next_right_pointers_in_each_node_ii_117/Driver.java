...
import static libraries.tree.binary_tree.level_connected_tree.Node.printLevelOrder;
...
class Driver {
  public static void main(String[] args) {
    ...
    /*
       ...
       Output: [1,#,2,3,#,4,5,7,#]
       Explanation: Given the above binary libraries.tree (Figure A), your function should populate
